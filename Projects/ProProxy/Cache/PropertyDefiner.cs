...
namespace ProProxy
{
    ...
    {
        private const string InvalidDelegateErrorMessage =
            "The {0} property cannot be activated for value of {1} type.";


        private static readonly MethodInfo CallPropertyGetterOpenGenericMethod =
            typeof(PropertyDefiner).GetTypeInfo().GetDeclaredMethod(nameof(CallPropertyGetter));


        private static readonly MethodInfo CallPropertySetterOpenGenericMethod =
            typeof(PropertyDefiner).GetTypeInfo().GetDeclaredMethod(nameof(CallPropertySetter));


        protected PropertyDefiner(Type type)
        {
            Type = type;
        ...
        public static Func<object, TResult> MakeFastPropertyGetter<TResult>(PropertyInfo propertyInfo)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(InvalidDelegateErrorMessage, propertyInfo.Name,
                    typeof(TResult)));
            }
        }
